...
- Follow existing patterns for WPF styles and repositories.
- Add concise XML doc comments to new classes/methods.
- Open a PR with a clear description and screenshots/GIFs if UI changes are made.

---

## License
This project is for educational purposes. Add a license file if you plan to distribute.
